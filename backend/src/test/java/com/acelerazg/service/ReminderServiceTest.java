...
class ReminderServiceTest {
    ...
    void createReminderSuccessful() {
        ...
        // WHEN
        Response<Task> response = reminderService.createReminder(1, "Buy milk", 2);
    ...
    void createReminderInvalidMessage() {
        ...
        // WHEN
        Response<Task> response = reminderService.createReminder(taskId, message, hoursInAdvance);
    ...
    void createReminderInvalidTaskId() {
        ...
        // WHEN
        Response<Task> response = reminderService.createReminder(taskId, "Message", 2);
    ...
    void createReminderTaskNotFound() {
        ...
        // WHEN
        Response<Task> response = reminderService.createReminder(1, "Message", 2);
    ...
    void updateReminderSuccessful() {
        ...
        // WHEN
        Response<Task> response = reminderService.updateReminder(1, 1, "Updated message", 5);
    ...
    void updateReminderInvalidIds() {
        ...
        // WHEN
        Response<Task> response = reminderService.updateReminder(taskId, reminderId, "Message", 2);
    ...
    void updateReminderTaskNotFound() {
        ...
        // WHEN
        Response<Task> response = reminderService.updateReminder(1, 1, "Message", 2);
    ...
    void updateReminderNotFound() {
        ...
        // WHEN
        Response<Task> response = reminderService.updateReminder(1, 99, "Message", 2);
    ...
    void updateReminderInvalidData() {
        ...
        // WHEN
        Response<Task> response = reminderService.updateReminder(1, 1, "", -3);
    ...
    void deleteReminderSuccessful() {
        ...
        // WHEN
        Response<Void> response = reminderService.deleteReminder(1, 1);
    ...
    void deleteReminderInvalidIds() {
        ...
        // WHEN
        Response<Void> response = reminderService.deleteReminder(taskId, reminderId);
    ...
    void deleteReminderNotFound() {
        ...
        // WHEN
        Response<Void> response = reminderService.deleteReminder(1, 99);
